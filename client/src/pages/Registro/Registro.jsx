                ...
                !procesoFinalizado ? (
                    <>
                        ...
                        <div className="registro__pasos">
                            ...
                            { paso === pasos[4] && <Finalizar datosCamping={{ usuario, password, correo, nombre }} imagenCamping={imagen} tamanos={[pequenaAncho, pequenaLargo, mediaAncho, mediaLargo, grandeAncho, grandeLargo]} tipos={[...tipos, ...conceptosGenerales]} caracteristicas={caracteristicas} zonas={zonas} acomodadores={acomodadores} procesoFinalizado={procesoFinalizado} setProcesoFinalizado={setProcesoFinalizado} setPaso={setPaso} /> }
                        </div>
